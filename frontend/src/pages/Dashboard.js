...
import {
  ...
  TableBody, TableCell, TableContainer, TableHead, TableRow, useTheme, useMediaQuery
} from '@mui/material';
import {
  ...
  return (
    <Box>
      <PageHeader
        ...
        subtitle="Real-time key performance indicators, sales trends, and transaction history."
      />
      ...
      <Grid container spacing={isMobile ? 1.5 : 3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} md={8}>
          <Paper sx={{ p: 3, borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.02)' }}>
